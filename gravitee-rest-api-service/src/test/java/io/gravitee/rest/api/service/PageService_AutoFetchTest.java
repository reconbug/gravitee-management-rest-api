...
public class PageService_AutoFetchTest {
    ...
    public void shouldNotFetch_NoSourcePage() throws Exception{
        ...
        when(pageRepository.findAll(any()))
                .thenReturn(new io.gravitee.common.data.domain.Page<>(Arrays.asList(mockPage), 1, 1, 1))
                .thenReturn(new io.gravitee.common.data.domain.Page<>(Collections.emptyList(), 1, 0, 1));
    ...
    public void shouldNotFetch_Descriptor_AutoFetch() throws Exception{
        ...
        when(pageRepository.findAll(any()))
                .thenReturn(new io.gravitee.common.data.domain.Page<>(Arrays.asList(mockRootPage), 1, 1, 1))
                .thenReturn(new io.gravitee.common.data.domain.Page<>(Collections.emptyList(), 1, 0, 1));
